...
create table dummy_metrics(
    ...
    passenger_count_most_common float
)
"""
...
def calculate_metrics_postgresql(curr, i):
    ...
    passenger_count_most_common = result["metrics"][4]["result"]["reference_characteristics"][
        "most_common"
    ]

    curr.execute(
        "insert into dummy_metrics(timestamp, prediction_drift, num_drifted_columns, share_missing_values, fare_amount_median, passenger_count_most_common) values (%s, %s, %s, %s, %s, %s)",
        (
